...
## When to use
- After `docs/experiments/<ID>.md` exists and **before** `research-implement` writes code.
...
- [ ] 10. Write docs/experiments/<ID>_plan.md from PLAN_TEMPLATE.md; link it from the spec; get user go-ahead → research-implement
```
