...
- `CHANGELOG.md`
- `docs/1_Strategy_and_Plans/agenda.md` (and the relevant
  `docs/experiments_specs/<lifecycle>/<ID>.md` if the change is tied to an experiment)
- git commit message
...
3. Mark related items in `docs/1_Strategy_and_Plans/agenda.md` (or the relevant
   `docs/experiments_specs/<lifecycle>/<ID>.md`). If a commit already exists, include the commit hash.
...
**Related:** `docs/1_Strategy_and_Plans/agenda.md` or
`docs/experiments_specs/<lifecycle>/<ID>.md` -> "experiment / item"
```
