...
GROUND_TRUTH_MORPHEMS = {
    ...
    "democratization": ["democrat iz ation", "democrat iza tion"],
    "industrialization": ["industrial iz ation", "industrial iza tion"],
    ...
    "bioengineering": ["bio engineer ing", "bio engine er ing"],
    "telecommunication": ["tele communication", "tele communicat ion"],
    "hydroelectric": ["hydro electric"],
    "thermometer": ["thermo meter"],
    "autobiography": ["auto bio graphy"],
    "hypersensitivity": ["hyper sensitiv ity", "hyper sensitive ity"],
    "multiculturalism": ["multi cultur al ism", "multi cultural ism"],
    ...
    "decentralization": ["de central iz ation", "de central iza tion"],
    "subconscious": ["sub conscious"],
    "interconnectedness": ["inter connect ed ness"],
    ...
    "meaninglessness": ["mean ing less ness"],
