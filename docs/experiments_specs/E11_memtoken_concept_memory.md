...
- **Status:** draft (design-only — queued behind E10; no implementation plan yet)
- **Serves:** same platform bet as [E10](E10_gemma_backbone_concept_memory.md) (pretrained-backbone
