...
- Attempt 3 (completed): Run id `concept_ar_prefix_H768L6C128D4_20260629_093840` · WandB [Link](https://wandb.ai/ksopyla/MrCogito/runs/concept_ar_prefix_H768L6C128D4_20260629_093840) · Run report [e05_attempt3_completed_20260630.md](../2_Experiments_Registry/run_reports/e05_attempt3_completed_20260630.md). **Verdict: TRAINING COMPLETE — 0.5 ep / 10.2B tokens, no divergence, eval_loss 5.40 → 3.83 across 17 evals (monotone).** Retune held throughout (LR 5e-5 + clip 0.5 + batch 8×accum3 effective 72); best checkpoint-68000 (eval_loss 3.829). Compute 68.2 GPU-h / 18.24 kWh / 10.20B tokens. Concept health + STS-B + supervised evaluation pending — see run report.
