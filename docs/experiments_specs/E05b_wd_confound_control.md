...
## Reading the result
- **RankMe < 15** ⇒ wd is the proximate collapse driver. The fix is then *wd management* (e.g., exempt the `bixt`/concept-injection params from wd, or MuonClip for Muon stability without wd) + the non-bypassable objective ([E05c](E05c_anticollapse_extension.md)).
