...
- **Status:** draft (revised 2026-07-05: write op = reuse BiXT's `lat←tok` direction, not a new
  module). Not yet approved / not the active focus — E08 is the committed next run; E09 complements it.
