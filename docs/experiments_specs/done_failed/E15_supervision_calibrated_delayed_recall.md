...
- WandB: [training run](https://wandb.ai/ksopyla/MrCogito/runs/backbone_concept_gemma_3_1b_pt_K512_concept_20260713_191759)
- Run report: [e15_supervision_calibrated_delayed_recall_20260713.md](../../2_Experiments_Registry/run_reports/e15_supervision_calibrated_delayed_recall_20260713.md)
- Verdict: **killed — objective protocol**. At 12,000 labels, the block-2 explicit-carry
  control reached only 0.98% accuracy (required ≥80%; chance 1.56%), so block-4 attribution
  was not run and no E10e read/write conclusion is permitted.
