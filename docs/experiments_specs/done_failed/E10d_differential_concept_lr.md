...
- Run id: `backbone_concept_gemma_3_1b_pt_K512_concept_20260712_173115`
- WandB: [Link](https://wandb.ai/ksopyla/MrCogito/runs/backbone_concept_gemma_3_1b_pt_K512_concept_20260712_173115)
- Run report: no dedicated report; canonical summary is in `agenda.md`
- Verdict: **killed** — the 3× concept-memory LR produced the strongest short-horizon
  calibration signal, but at the ~25M gate static/shuffle deltas were only
  +0.001103/+0.001161 nats: below 0.01 and less than the required +0.002 improvement
  over E10c. Geometry remained healthy (RankMe 108.2; centered 120.9) and eval CE was
  1.8151, so update scale was not the missing ingredient.
