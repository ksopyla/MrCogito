...
- **Spec:** [E10_gemma_backbone_concept_memory.md](E10_gemma_backbone_concept_memory.md) ·
  **Status:** implemented and run; mechanism branch closed 2026-07-13 after E10b–E10e
  failed to recover persistent recurrence; original matched-control comparison unresolved
