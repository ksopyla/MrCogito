...
- **Status:** **on hold / design-only.** [E05b](../done_success/E05b_wd_confound_control.md)
  is complete and ruled out weight decay; E05d remains gated behind the unrun
  [E05c](E05c_anticollapse_extension.md) objective-side test and is not scheduled.
