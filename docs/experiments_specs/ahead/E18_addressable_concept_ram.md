...
- **Implementation plan:** [E18_addressable_concept_ram_plan.md](E18_addressable_concept_ram_plan.md)
- **ID note:** **E18** (author decision 2026-08-17). Briefly numbered E17d as an
  E17-family letter suffix; restored to E18. No other experiment occupied this
  ID. GitHub PR #18 is not an experiment ID.
