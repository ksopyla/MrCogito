...
- Verdict: **mixed.** Tiny INDEX near-pass at 8k. Tiny MATCH/select/chain walls. GPU seq=512
  ...
  **FAIL**. Same geometry as ordered hops glob=2 S1 PASS 25.85 / E18
  live 5.56. Shuffle is the wall for both global-read arms. 8k not
  run. Do not 16k. Do not relabel ordered hops 25.85 as this score.
