...
remainder-on. Do not r=2/r=6 A/B. Do not MATCH 1408. Do not stack
`keep_local_swa` / extra hops / glob=2 / anchors. Next: **STOP further
r=2/r=6 pooling A/Bs** (parent decides; do not run here). MATCH length
