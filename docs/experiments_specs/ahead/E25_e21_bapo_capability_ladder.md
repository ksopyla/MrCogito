...
- Verdict: **mixed.** Tiny INDEX near-pass at 8k. Tiny MATCH/select/chain walls. GPU seq=512
  ...
  **H=256 SSMax log S1 FAIL** (25.7% / 0 bits @800 vs 0.75× E18 47.89 and vs
  ...
  1024. Next: **do not stack 1024 SELECT**.
...
1024. Do not extra-step (floor). Do not 16k. Next: **do not stack 1024 SELECT**
(no remainder-on, no r=1 identity, no extra width). Remaining walls: 512 chain
K1, 256 hops FAIL. Not hops. Not 4k. Not Glyph. Do not unfreeze `u`/`delta`.
