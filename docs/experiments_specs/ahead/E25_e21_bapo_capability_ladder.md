...
- Verdict: **mixed.** Tiny INDEX near-pass at 8k. Tiny MATCH/select/chain walls. GPU seq=512
  ...
  **(264 S1 PASS, 272 FAIL]**. Next: seq=**268** (do not run here).
  ...
  MATCH wall is **(1024 PASS, 1280 FAIL]**. 8k not run. No new scale enum.
...
MATCH length extra-steps** (do not 1152/1408). Parent decides architecture
(e.g. r=1 identity at the failing length). Do not stack knobs. Do not
