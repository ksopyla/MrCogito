...
- **Status:** active (tiny DNA limits; 512 concat 0 bits; raw/identity/raw-KV PASS;
  ...
  **384 chain hops `--global_layers 2` K1** dense 24.5% / 0 bits @3200
  (2.802M; e18/e21 skipped; wall **(256 S0 PASS, 384 K1]**; 8k not run).
