...
- Verdict: **mixed.** Tiny INDEX near-pass at 8k. Tiny MATCH/select/chain walls. GPU seq=512
  ...
  **46.2% / 8.87 bits** @2850 climbing, then **27.6% / 0.02 bits** @8000
  ...
  pass S1 via 0.75×0 — E18 is live. 8k ran. Do not 16k. E21 hops wall at
  glob=2 is **(256 S1 PASS, 272 FAIL]**.
