...
- **Status:** active — **STOP: ladder mapped.** DNA S0-capable USER_CORE rungs and
  extra-hop transfers are mapped at stop resolution. No unmapped recipe that can
