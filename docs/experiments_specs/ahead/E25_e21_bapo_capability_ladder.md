...
- Verdict: **mixed.** Tiny INDEX near-pass at 8k. Tiny MATCH/select/chain walls. GPU seq=512
  ...
  **K1** (dense 24.2% / 0 bits @3200; e18/e21 skipped). Seq=512 packed `chain_ordered`
  ...
  not required. Next: **do not another SELECT r**.
...
required. Do not 16k. Next: **do not another SELECT r**. Remaining walls:
512 chain K1, 256 hops FAIL. Not r=9/11. Not hops. Not 4k. Not Glyph. Do not
unfreeze `u`/`delta`.
