...
- Verdict: **mixed.** Tiny INDEX near-pass at 8k. Tiny MATCH/select/chain walls. GPU seq=512
  ...
  **H=256 SSMax log S1 FAIL** (25.7% / 0 bits @800 vs 0.75× E18 47.85 and vs
  ...
  hold here. Next: **stop 1024 SELECT**.
