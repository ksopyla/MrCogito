...
- **Status:** active (tiny DNA limits; 512 concat 0 bits; raw/identity/raw-KV PASS;
  ...
  **256 `--recipe chain_shuffled` n_dist=0 `--key_len 13 --global_layers 2` H=256 log S1 PASS 16.60 vs 12.28** (dense **99.3% / 25.66 bits** @700 S0 PASS; E18 live **71.5% / 16.37 bits** @800; E21 **71.9% / 16.60 bits** @800; vs 0.75× dense 19.24 FAIL; shuffled distractor wall **(n_dist=0 S1 PASS, n_dist=2 S1 FAIL]**; 8k not run; K2 PASS).
...
- Verdict: **mixed.** Tiny INDEX near-pass at 8k. Tiny MATCH/select/chain walls. GPU seq=512
  ...
  **FAIL**. Same geometry as ordered hops glob=2 S1 PASS 25.85 / E18
  ...
  chain. Shuffled distractor wall **(n_dist=0 S1 PASS, n_dist=2 S1
  FAIL]**. 8k not run. Do not 16k. Do not relabel n_dist=2 0 bits or
  ordered hops 25.85 as this score.
