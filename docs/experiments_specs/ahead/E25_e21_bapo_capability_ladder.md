...
- **Status:** active (tiny DNA limits; 512 concat 0 bits; raw/identity/raw-KV PASS;
  ...
  **512 recall r=10 frozen mean 0 bits** (chance floor @800; unexpected vs r=12
  live; stop stacking r-sweeps);
