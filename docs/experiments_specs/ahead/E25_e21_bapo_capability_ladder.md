...
- **Status:** active (tiny DNA limits; 512 concat 0 bits; raw/identity/raw-KV PASS;
  ...
  **1536 recall r=8 rem-off H=256 log S1 FAIL 0 vs 39.44** (E18 live 52.58 @800; exclusive MATCH wall **(1024 PASS, 1536 FAIL]**; chance @800; 8k not run);
  ...
  **1536 recall r=8 rem-off H=256 log S1 FAIL 0 vs 39.44** (dense 63.65 S0 PASS; E18 live **52.58** @800; E21 **0 bits** chance @800; vs 0.75× live E18 39.44 and vs 0.75× dense 47.74; exclusive MATCH wall **(1024 PASS, 1536 FAIL]**; 8k not run; K2 PASS).
...
- Verdict: **mixed.** Tiny INDEX near-pass at 8k. Tiny MATCH/select/chain walls. GPU seq=512
  ...
  **(264 S1 PASS, 272 FAIL]**. Next: seq=**268** (do not run here).
  ...
  passed at 1024 is chance at 1536 on the same leftover residue 2. Exclusive
  MATCH wall is **(1024 PASS, 1536 FAIL]**. 8k not run. No new scale enum.
