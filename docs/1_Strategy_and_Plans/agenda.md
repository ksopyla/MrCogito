...
## Current focus
- **E18 Addressable concept RAM (draft + plan, 2026-08-17).** Next architectural
  ...
  in E17c. Do **not** retune E17c with more tokens; do **not** launch E18 until
...
- **E17c 300M closed (2026-08-15).** Carryless first-64 Δpermutation **0.594** CI [0.543, 0.645]
  ...
  Dense `gated_replace` of all 128 slots is the diagnosed collapse mechanism.
