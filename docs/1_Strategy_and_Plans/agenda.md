...
## Current focus
- **2026-09-14 — E25 E21 capability ladder (tiny limits; 512 concat wall; raw PASS; inplace identity PASS; r=16 mean INDEX; learned pool 0 bits; 1024 mean S1 PASS; 512 recall mean 0 bits; 512 recall r=1 identity S1 PASS).**
  ...
  **0 bits** @800 — learning wrecks; keep frozen mean. Seq=1024 frozen mean **91.2% /
  53.82 bits** @8k (H=256 SSMax log; E18 live 63.12 bits). Seq=512 `recall_single`
  frozen mean **0 bits** @800 (E18 live 47.94). Seq=512 `recall_single` r=1 identity
  **91.6% / 43.08 bits** @800 (S1 PASS vs E18 35.00 and dense 35.77). Exclusive identity
