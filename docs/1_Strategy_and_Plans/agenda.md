...
## Current focus
- **2026-09-15 — E25 closed (`done_success` mapped).** DNA USER_CORE E21 walls measured vs dense and uncompressed E18. Original-objective plots + bits/flow/B/tok filled from probe JSON. Spec/plan moved to `done_success/`. No remaining S0-capable USER_CORE hunt. [spec](../experiments_specs/done_success/E25_e21_bapo_capability_ladder.md) · [map](../2_Experiments_Registry/run_reports/e25_dna_s0_ladder_mapped_20260915.md) · [audit](../2_Experiments_Registry/run_reports/e25_original_objective_completion_audit_20260915.md).
- **2026-09-15 — E25 E21 capability ladder STOP: ladder mapped (tiny limits; 512 concat wall; raw PASS; inplace identity PASS; r=16 mean INDEX; MATCH remainder-on S1 through r=16; remainder-off r=10/16 chance, r=12 S1 FAIL; SELECT r=8 rem-off S1 PASS, r=12 rem-on S1 PASS, r=16 rem-on live S1 FAIL; SELECT identity PASS; 1024 MATCH r=8 rem-off H=128 S1 FAIL, H=256 log S1 PASS 60.35; 1280 MATCH r=8 rem-off H=256 log chance (exclusive wall (1024 PASS, 1280 FAIL]); 1280 MATCH r=1 identity H=256 log S1 PASS 63.94 (r=8 FAIL was pooling); 1536 MATCH r=1 identity H=256 log S1 FAIL 1.50 (identity wall (1280 PASS, 1536 FAIL]); 1280 MATCH r=4 frozen mean H=256 log S1 FAIL 24.91 @800 / 0 @8k (pooling wall (r=1 PASS, r=4 FAIL]; 8k ran); 1280 MATCH r=4 rem-on H=256 log S1 FAIL 45.31 @1550 / 0 @8k (leftover-2 rescue unreplicated; pooling wall stands; 8k ran); 1024 SELECT r=8 rem-off H=256 log chance; 1024 SELECT r=1 identity H=256 log chance; 1024 SELECT SWA-unsever `--message_keep_local_swa` chance 0.01 bits; 1024 SELECT extra exclusive hop `--message_extra_slot_attends 1` chance 0 bits; 1024 SELECT type_marks anchors `--message_global_anchors type_marks` 0 bits @800 / 31.90 @1050 S1 FAIL vs 0.75× dense; 1024 SELECT type_marks 8k extra-step S1 FAIL 6.48 vs live E18 63.96; 1024 SELECT extra hop + unfrozen slot K/V `--message_update_slot_kv` chance 0 bits; 1024 SELECT second exclusive global layer `--global_layers 2` chance 0 bits; 1024 SELECT QUERY-side anchors `--message_global_anchors query_side` chance 0 bits (4 tokens vs 1024, extra 4); 768 SELECT r=1 identity H=256 log chance 0.01 bits; 640 SELECT r=1 identity H=256 log S1 PASS 63.95 vs 47.93 (`--seq_len 640`); 704 SELECT r=1 identity H=256 log chance 0 bits (`--seq_len 704`); 672 SELECT r=1 identity H=256 log S1 PASS 63.96 vs 47.95 (`--seq_len 672`); 688 SELECT r=1 identity H=256 log S1 PASS 62.68 vs 47.97 (`--seq_len 688`; 800 climb 31.57, extra-step 99.5% @400; wall was (688, 704]); 696 SELECT r=1 identity H=256 log S1 FAIL 0 bits (`--seq_len 696`; chance @800; wall was (688, 696]); 692 SELECT r=1 identity H=256 log S1 PASS 62.76 vs 47.91 (`--seq_len 692`; 99.8% @500; wall now (692, 696]); 696 SELECT pack_stride 32 S1 FAIL 31.67 vs 47.50 @800 / 0 bits @8k (`--message_pack_stride 32`; leftover drop to 640 slots does not rescue 696); 696 SELECT `--evidence_align spread` K1 (dense 24.7% / 0 bits @3200; e18/e21 skipped); 4k INDEX r=16 rem-off H=256 log chance vs 0.75× dense; 2048 INDEX r=16 rem-off H=256 log chance vs 0.75× dense; 1536 INDEX r=16 rem-off H=256 log chance vs 0.75× dense (shared wall (1024, 1536]); 512 chain K1; 256 hops FAIL vs dense; 256 hops `--global_layers 2` S1 PASS 25.85 vs 4.17 (E18 live 5.56; 8k not run); 512 hops `--global_layers 2` K1 dense 22.5% / 0 bits @3200 (e18/e21 skipped; 8k not run); 384 hops `--global_layers 2` K1 dense 24.5% / 0 bits @3200 (e18/e21 skipped; 8k not run); 320 hops `--global_layers 2` K1 dense 26.2% / 0 bits @3200 (e18/e21 skipped; 8k not run); 288 hops `--global_layers 2` S0 PASS / E21 FAIL dense 93.1% / 22.20 bits @3200, E18 0, E21 0 (chance @800/@3200; vs 0.75× dense 16.65; dense wall (288 S0 PASS, 320 K1]; 8k not run); 272 hops `--global_layers 2` S0 PASS / E21 FAIL dense 99.0% / 25.33 bits @2850, E18 live 25.35/23.64, E21 8.87 @2850 then 0.02 @8k (S1 FAIL vs 0.75× live E18 19.02/17.73; 8k ran; E21 wall was (256 S1 PASS, 272 FAIL]; 264 hops `--global_layers 2` S1 PASS dense 82.3% / 17.65 bits @3200, E18 ~0 @3200 then live 9.87 @8000, E21 11.00 @3200 then 99.0% / 25.61 bits @4050 extra-step (S1 PASS vs 0.75× live E18 7.40 and vs 0.75× dense 13.24; 8k ran; E21 wall **(264 S1 PASS, 272 FAIL]**); 272 hops `--global_layers 2 --message_keep_local_swa` S1 PASS dense 94.8% / 23.53 bits @3200, E18 ~0 @3200 then live 25.46 @7800, E21 3.72 @3200 then 99.2% / 25.55 bits @4650 extra-step (S1 PASS vs 0.75× live E18 19.10 and vs 0.75× dense 17.65; 8k ran; SWA-sever was the 272 miss; default keep_local_swa stays false); 288 hops `--global_layers 2 --message_keep_local_swa` K1 dense 47.0% / 8.80 bits @3200 (e18/e21 skipped; best 50.7% @3000; 8k not run; keep-SWA wall **(272 S1 PASS, 288 K1]**; prior 288 without flag was dense S0 PASS 22.20); 696 SELECT r=1 identity `--message_keep_local_swa` H=256 log S1 FAIL 0.01 bits (`--seq_len 696`; chance @800; E18 live 63.91; wall **(692 PASS, 696 FAIL]** even unsevered; 8k not run); 1536 MATCH r=1 identity `--global_layers 2` H=256 log S1 FAIL 0 bits (`--seq_len 1536`; chance @800; this-JSON E18 0; scored vs 0.75× dense 47.99; glob=1 was 1.50 / live E18 63.95; identity wall stands at glob=2; 8k not run); 272 hops `--global_layers 2 --message_extra_slot_attends 1` S1 PASS dense 80.5% / 15.84 bits @3200, E18 live 10.17 @3200 then 25.49 @2550, E21 8.49 @3200 then 99.0% / 25.48 bits @5450 extra-step (S1 PASS vs 0.75× live E18 19.12 and vs 0.75× dense 11.88; 8k ran; extra hop substitutes for local SWA at 272; SWA still severed; default extra_slot_attends stays 0); 288 hops `--global_layers 2 --message_extra_slot_attends 1` S1 FAIL dense 99.5% / 25.77 bits @1850, E18 0, E21 0 (chance @800/@1850; vs 0.75× dense 19.32; do not pass via 0.75×0; K2 PASS; 8k not run; extra-hop wall **(272 S1 PASS, 288 FAIL]**; SWA still severed; default extra_slot_attends stays 0); 512 MATCH2 (`recall` n_dist=2) H=128 identity K1 dense 55.8% / 18.44 bits @3200 (e18/e21 skipped; 8k not run); 512 MATCH2 (`recall` n_dist=1) H=128 identity S1 PASS 20.78 vs 19.99 (dense 99.3% / 47.03 @1650; E18 live 26.66; E21 20.78; 2-item; vs 0.75× dense FAIL; 8k not run); 1024 MATCH2 (`recall` n_dist=1) H=128 identity S1 PASS 61.81 vs 44.11 (dense 93.5% / 58.81 @3200; E18 ~0; E21 61.81; 2-item 64-bit; scored vs 0.75× dense; 8k not run); 1280 MATCH2 (`recall` n_dist=1) H=128 identity S1 FAIL 0 vs 47.21 (dense 98.9% / 62.94 @3200; E18 ~0; E21 0.01 bits chance; 2-item 64-bit; length wall **(1024 S1 PASS, 1280 FAIL]**; 8k not run); 1152 MATCH2 (`recall` n_dist=1) H=128 identity K1 (dense 24.1% / 0.00 bits @3200; 24.9% @800; chance every eval; e18/e21 skipped; 8k not run; dense K1 hole inside (1024 S1 PASS, 1280 FAIL]; **STOP MATCH2 2-item length extra-steps**); 256 `--recipe chain` shuffled REACHABILITY `--key_len 13 --global_layers 2` S1 FAIL 0 vs 17.17 (dense 93.1% / 22.89 S0 PASS; E18 0; E21 0 chance @800/@3200; same geometry as ordered hops S1 PASS 25.85; 8k not run); 256 `--recipe chain_shuffled` n_dist=0 `--key_len 13 --global_layers 2` S1 PASS 16.60 vs 12.28 (dense 99.3% / 25.66 @700 S0 PASS; E18 live 16.37; E21 16.60; vs 0.75× dense 19.24 FAIL; 8k not run); 256 `--recipe chain --n_distractors 1` `--key_len 13 --global_layers 2` S1 FAIL 6.28 vs 19.08 (dense 86.4% / 21.54 @3200 S0 PASS; E18 live 25.44 @2450; E21 0 @800 then 6.28 @3200; vs 0.75× dense 16.16 FAIL; shuffled distractor wall **(n_dist=0 S1 PASS, n_dist=1 S1 FAIL]**; 8k not run); 256 `--recipe chain --n_distractors 1` `--key_len 13 --global_layers 2 --message_keep_local_swa` S1 FAIL 14.77 vs 15.71 (dense 99.2% / 25.56 @3000 S0 PASS; E18 live 20.95 @8000; E21 1.67 @800 then 6.52 @3000 then 14.77 @8000; vs 0.75× dense 19.17 FAIL; keepswa lifts vs severed 6.28 but does not clear S1; hops 272 keepswa 25.55 does not transfer; wall **(n_dist=0 S1 PASS, n_dist=1 S1 FAIL]** even unsevered; 8k ran); 256 `--recipe chain --n_distractors 1` `--key_len 13 --global_layers 2 --message_extra_slot_attends 1` S1 PASS 24.08 vs 7.31 (dense 93.8% / 23.92 @3200 S0 PASS; this-JSON E18 9.75; E21 6.85 @800 then 24.08 @3200; vs 0.75× dense 17.94 PASS; vs 0.75× prior live E18 19.08 PASS; extra hop composes extra shuffled edge without restoring SWA; keepswa off; 8k not run); 256 `--recipe chain --n_distractors 2` `--key_len 13 --global_layers 2 --message_extra_slot_attends 1` S1 PASS 22.60 vs 17.21 (dense 93.4% / 22.94 @3200 S0 PASS; this-JSON E18 0; E21 3.81 @800 then 22.60 @3200; scored vs 0.75× dense because E18 ≈ 0; do not pass via 0.75×0; extra hop rescues packed n_dist=2 without restoring SWA; keepswa off; 8k not run); 1280 MATCH2 (`recall` n_dist=1) H=128 identity `--message_extra_slot_attends 1` S1 FAIL 0 vs 47.40 (dense 99.5% / 63.20 @1150 S0 PASS; E18 0; E21 0 @800 / 0.01 @1150 chance; extra hop does not transfer from shuffled n_dist=2; 2-item length wall **(1024 S1 PASS, 1280 FAIL]** even extra hop; 8k not run); 1280 MATCH (`recall_single`) r=8 rem-off H=256 log `--message_extra_slot_attends 1` S1 FAIL 0 vs 47.99 (dense 93.7% / 58.94 @3200 S0 PASS; E18 live 63.99 @1200; E21 0 @800 / 0.01 @3200 chance; extra hop does not rescue r=8 MATCH pooling; exclusive wall **(1024 S1 PASS, 1280 FAIL]** even extra hop; 8k not run); 1536 MATCH (`recall_single`) r=1 identity H=256 log `--message_extra_slot_attends 1` S1 FAIL 0 vs 47.96 (dense 100% / 63.92 @200 S0 PASS; E18 live 63.94 @350; E21 0 @800 chance; extra hop does not rescue identity MATCH capacity; wall **(1280 PASS, 1536 FAIL]** even extra hop; 8k not run)).**
  ...
  **85.8% / 52.58 bits** @800; chance every eval). Exclusive MATCH wall
  was **(1024 PASS, 1536 FAIL]**. 8k not run. Seq=1280 `recall_single`
  `--scale bridge_1k --seq_len 1280` r=8 rem-off H=256 SSMax log **22.8% /
  0 bits** @800 (**S1 FAIL** vs 0.75× live E18 47.96 and vs 0.75× dense
  47.89; E18 live **100% / 63.95 bits** @400; chance every eval). Exclusive
  MATCH r=8 wall **(1024 PASS, 1280 FAIL]**. 8k not run. Seq=1280
  `recall_single` `--scale bridge_1k --seq_len 1280` r=1 identity rem-off
  H=256 SSMax log **100% / 63.94 bits** @800 (**S1 PASS** vs 0.75× live
  E18 47.96 and vs 0.75× dense 47.97; E18 live **100% / 63.95 bits** @400;
  chance through 600, click 47.9% @650). r=8 FAIL was pooling, not identity
  capacity. 8k not run. Seq=1536 `recall_single` `--scale bridge_1k
  --seq_len 1536` r=1 identity rem-off H=256 SSMax log **29.2% / 1.50
  bits** @800 (**S1 FAIL** vs 0.75× live E18 47.96 and vs 0.75× dense
  47.96; E18 live **100% / 63.95 bits** @400; chance through 750, last-eval
  wiggle flow 0.023).   Identity MATCH wall **(1280 PASS, 1536 FAIL]**.
  8k not run. Seq=1536 `recall_single` `--scale bridge_1k
  --seq_len 1536` r=1 identity `--global_layers 2` rem-off H=256 SSMax
  log **24.7% / 0 bits** @800 (**S1 FAIL** vs 0.75× dense 47.99; this-JSON
  E18 **0 bits** @800 — do not pass via 0.75×0; chance every eval). glob=1
  at this length was E21 1.50 / live E18 63.95. Two exclusive global layers
  do not recover identity MATCH. **STOP MATCH glob=2 stacks at 1536**.
  Seq=1280 `recall_single` `--scale bridge_1k --seq_len 1280`
  r=4 frozen mean rem-off H=256 SSMax log **47.4% / 24.91 bits** @800
  (climbing, S1 FAIL vs 0.75× live E18 47.98) then **22.8% / 0 bits**
  @8000 (**S1 FAIL** vs 0.75× live E18 47.29 and vs 0.75× dense 47.98;
  800 climb did not replicate). Pooling-ratio wall at 1280 **(r=1 PASS,
  r=4 FAIL]**. 8k ran. Do not 16k. Seq=1280 `recall_single`
  `--scale bridge_1k --seq_len 1280` r=4 rem-on
  `--message_pool_remainder` H=256 SSMax log **72.0% / 45.31 bits**
  @1550 (climbing after ~6.80 @800) then **22.8% / 0 bits** @8000
  (**S1 FAIL** vs 0.75× live E18 47.97 and vs 0.75× dense 46.79; leftover
  **2** kept; 1550 climb did not replicate). Leftover rescue that worked
  at 512 MATCH r=10 does not hold at 1280 r=4. Pooling-ratio wall stays
  **(r=1 PASS, r=4 FAIL]**. 8k ran. Do not 16k. Seq=1024 `select_1decoy` r=8 rem-off H=256 SSMax
  ...
  **24.5% / 0 bits** (chance @800 and @3200; **S1 FAIL** vs 0.75× dense
  ...
  is **(288 S0 PASS, 320 K1]**.
  Seq=272 hops `--global_layers 2` (`--scale bridge --seq_len 272`): dense
  **99.0% / 25.33 bits** @2850 (**S0 PASS**); E18 live **99.0% / 25.35
  bits** @1650 and **95.2% / 23.64 bits** @8000; E21 **8.87 bits** @2850
  (climbing, short of S1) then **0.02 bits** @8000 (**S1 FAIL** vs 0.75×
  live E18 19.02 / 17.73; 8k ran; do not 16k; do not pass via 0.75×0 —
  E18 is live). E21 hops wall at glob=2 was **(256 S1 PASS, 272 FAIL]**.
  Seq=264 hops `--global_layers 2` (`--scale bridge --seq_len 264`): dense
  **82.3% / 17.65 bits** @3200 (**S0 PASS**); E18 ~0 @3200 then live
  ...
  **(264 S1 PASS, 272 FAIL]**.
  ...
  Seq=288 hops `--global_layers 2 --message_keep_local_swa` (`--scale bridge
  --seq_len 288`): dense **47.0% / 8.80 bits** @3200 (**S0 FAIL / K1**;
  best 50.7% @3000; e18/e21 skipped). Do not score E21. 8k not run. Do
  not 16k. Keep-SWA hops wall **(272 S1 PASS, 288 K1]**. Prior 288 without
  the flag remains dense S0 PASS 22.20 / E21 0. Default
  `--message_keep_local_swa` stays false.
  Seq=272 hops `--global_layers 2 --message_extra_slot_attends 1` (`--scale
  bridge --seq_len 272`; keep_local_swa off): dense **80.5% / 15.84 bits**
  @3200 (**S0 PASS**); E18 live **10.17 bits** @3200 then **25.49 bits**
  @2550; E21 **8.49 bits** @3200 (chance @800) then **99.0% / 25.48 bits**
  @5450 extra-step (**S1 PASS** vs 0.75× live E18 19.12 and vs 0.75× dense
  11.88; 8k ran; do not 16k). Same recipe without extra hops was E21
  **0.02 bits @8k**. Extra exclusive hop substitutes for local SWA at 272.
  Default `--message_extra_slot_attends` stays 0.
  Seq=288 hops `--global_layers 2 --message_extra_slot_attends 1` (`--scale
  bridge --seq_len 288`; keep_local_swa off): dense **99.5% / 25.77 bits**
  @1850 (**S0 PASS**); E18 **26.8% / 0 bits**; E21 **23.8% / 0 bits**
  (chance @800 and @1850; **S1 FAIL** vs 0.75× dense 19.32; do not pass
  via 0.75×0). 8k not run. Extra-hop hops wall **(272 S1 PASS, 288 FAIL]**.
  Default `--message_extra_slot_attends` stays 0.
  Seq=696 packed `select_1decoy` `--message_keep_local_swa` r=1 identity
  H=256 SSMax log **25.0% / 0.01 bits** @800 (**S1 FAIL** vs 0.75× live
  E18 47.93 and vs 0.75× dense 47.94; E18 **100% / 63.91 bits** @350;
  chance every eval). Same 696 recipe without the flag was E21 0 bits.
  Hops 272 keep_local_swa S1 PASS does not transfer. SELECT cliff is
  exclusive type-then-value, not hops-class SWA sever. Do not extra-step
  (floor). Do not 16k. Wall **(692 PASS, 696 FAIL]** stands even unsevered.
  ...
  **(1024 PASS, 1536 FAIL]**. INDEX length extra-steps are **stopped**.
  ...
  extra-step (floor). Do not 16k.
  Next: **STOP MATCH glob=2 stacks at 1536**; identity wall
  **(1280 PASS, 1536 FAIL]** stands even with two exclusive global layers.
  Do not seq=1408 glob=1. Do not extra hops / keepswa / anchors. Do not
  seq=694. Do not pack_stride / spread / window 32.
  STOP identity MATCH extra-steps at this 256-token resolution
  (do not 1408). Do not 2048 identity MATCH. STOP MATCH r=8 length
  extra-steps (do not 1152/1408). Hops length extra-steps stay stopped
  (not 260, not 268). Keep-SWA hops length extra-steps **stopped at 288 K1**.
  Extra-hop hops length extra-steps **stopped at 288 FAIL**.
  Seq=512 packed `--recipe recall` MATCH2 n_distractors=2 H=128 identity
  **K1** (dense **55.8% / 18.44 bits** @3200; best 55.9% @2450; 51.8%
  @800; e18/e21 skipped; 8k not run). Same recipe as 512 `recall_single`
  identity S1 PASS 43.08 except 3-item MATCH2. Tiny MATCH2 H=128 stays
  ~30% K1. INDEX length extra-steps stay stopped. Do not stack
  MATCH compressor knobs (`keep_local_swa` / extra hops / glob=2 /
  anchors).
  **STOP: ladder mapped.** DNA S0-capable USER_CORE rungs and extra-hop
  transfers are mapped at stop resolution. No unmapped recipe that can
  plausibly pass dense S0 remains. No GPU hunt 2026-09-15 mapping close.
  Spec/plan in `done_success/` (mapped). Wall table:
  [DNA S0 ladder mapped](../2_Experiments_Registry/run_reports/e25_dna_s0_ladder_mapped_20260915.md).
  Remaining DNA walls (mapped, do not hunt):
  MATCH exclusive **(1024 PASS, 1280 FAIL]** r=8 (E18 live 63.95 at 1280 / 52.58 at 1536; E21 r=8 0), identity MATCH **(1280 PASS, 1536 FAIL]** even `--global_layers 2` (glob=1 E21 1.50 / live E18 63.95; glob=2 E21 0 / this-JSON E18 0 @800; **STOP extra-steps**; **STOP MATCH glob=2 stacks**), pooling-ratio MATCH at 1280 **(r=1 PASS, r=4 FAIL]** (rem-off 24.91@800/0@8k; rem-on leftover-2 45.31@1550/0@8k unreplicated; **STOP remainder stacks**), SELECT length **(692 PASS, 696 FAIL]** even `--message_keep_local_swa` (0.01 bits; leftover-drop, spread K1, and window 32 also failed; **STOP keepswa stacks**), INDEX **(1024 PASS, 1536 FAIL] shared with E18**, hops glob=2 dense **(288 S0 PASS, 320 K1]**, hops glob=2 E21 severed-SWA **(264 S1 PASS, 272 FAIL]**, hops glob=2 keep_local_swa **(272 S1 PASS, 288 K1]**, hops glob=2 extra-hop **(272 S1 PASS, 288 FAIL]** (keepswa-class rescue at 272 does not hold at 288; SWA still severed; **STOP extra-hop hops length extra-steps**), 512 MATCH2 (`recall` n_dist=2) H=128 **K1** (dense 55.8% / 18.44 bits @3200; e18/e21 skipped), 512 MATCH2 (`recall` n_dist=1) H=128 **S1 PASS 20.78 vs 19.99** (2-item; vs 0.75× dense FAIL; item-count wall **(2-item S1 PASS, 3-item dense K1]**), 1024 MATCH2 (`recall` n_dist=1) H=128 **S1 PASS 61.81 vs 44.11** (2-item 64-bit; E18 ~0; scored vs 0.75× dense; E21 beats dense 58.81), 1280 MATCH2 (`recall` n_dist=1) H=128 **S1 FAIL 0 vs 47.21** (2-item 64-bit; E18 ~0; E21 chance; 2-item length wall **(1024 S1 PASS, 1280 FAIL]**; 8k not run), 1152 MATCH2 (`recall` n_dist=1) H=128 **K1** (dense 24.1% / 0.00 bits @3200; chance; e18/e21 skipped; dense K1 hole inside (1024, 1280]; **STOP MATCH2 2-item length extra-steps**), 256 `--recipe chain` shuffled REACHABILITY glob=2 **S1 FAIL 0 vs 17.17** (dense 93.1% / 22.89 S0 PASS; E18 0; E21 0 chance; same geometry as ordered hops S1 PASS 25.85; 8k not run), 256 `--recipe chain_shuffled` n_dist=0 glob=2 **S1 PASS 16.60 vs 12.28** (dense 25.66; E18 live 16.37; E21 16.60), 256 `--recipe chain --n_distractors 1` glob=2 **S1 FAIL 6.28 vs 19.08** (dense 21.54; E18 live 25.44; E21 0 @800 then 6.28 @3200; shuffled distractor wall **(n_dist=0 S1 PASS, n_dist=1 S1 FAIL]**; **STOP shuffled-distractor extra-steps**; 256 `--recipe chain --n_distractors 1` glob=2 extra hop **S1 PASS 24.08 vs 7.31**; 256 `--recipe chain --n_distractors 2` glob=2 extra hop **S1 PASS 22.60 vs 17.21** (dense 22.94; E18 0; E21 3.81 @800 then 22.60 @3200; extra hop rescues packed n_dist=2; **STOP extra-hop shuffled-distractor extra-steps**); 1280 MATCH2 (`recall` n_dist=1) H=128 extra hop **S1 FAIL 0 vs 47.40** (dense 99.5% / 63.20 @1150 S0 PASS; E18 0; E21 0 @800 / 0.01 @1150 chance; extra hop does not rescue 2-item MATCH2 length wall **(1024 S1 PASS, 1280 FAIL]** even extra hop; 8k not run), 1280 MATCH (`recall_single`) r=8 rem-off H=256 log extra hop **S1 FAIL 0 vs 47.99** (dense 93.7% / 58.94 @3200 S0 PASS; E18 live 63.99 @1200; E21 0 @800 / 0.01 @3200 chance; extra hop does not rescue r=8 MATCH pooling; exclusive wall **(1024 S1 PASS, 1280 FAIL]** even extra hop; **STOP extra-hop transfer to MATCH pooling**; 8k not run), 1536 MATCH (`recall_single`) r=1 identity H=256 log extra hop **S1 FAIL 0 vs 47.96** (dense 100% / 63.92 @200 S0 PASS; E18 live 63.94 @350; E21 0 @800 chance; extra hop does not rescue identity MATCH capacity; wall **(1280 PASS, 1536 FAIL]** even extra hop; **STOP extra-hop transfer to MATCH identity capacity**; 8k not run), hops glob=2 E18 live-weak at 264 / live-strong at 272 / dead at 288, 512 chain **K1 at glob=1 and glob=2**, 256 hops
  **FAIL at glob=1 / PASS at glob=2**. Not remainder-on. Not H=512. Not
  ...
  Spec [E25](../experiments_specs/done_success/E25_e21_bapo_capability_ladder.md) ·
  ...
  [288 hops glob2 keep_local_swa](../2_Experiments_Registry/run_reports/e25_bridge288_chain_k13_glob2_keepswa_20260915.md) ·
  [696 select keep_local_swa](../2_Experiments_Registry/run_reports/e25_bridge1k_696_ip_id_h256_keepswa_select_20260915.md) ·
  [1536 MATCH identity glob=2](../2_Experiments_Registry/run_reports/e25_bridge1k_1536_ip_id_h256_glob2_recall_20260915.md) ·
  [272 hops glob2 extra hop](../2_Experiments_Registry/run_reports/e25_bridge272_chain_k13_glob2_extrahop_20260915.md) ·
  [288 hops glob2 extra hop](../2_Experiments_Registry/run_reports/e25_bridge288_chain_k13_glob2_extrahop_20260915.md) ·
  [512 MATCH2 n_dist=2 H=128 identity K1](../2_Experiments_Registry/run_reports/e25_bridge512_ip_id_match2_20260915.md) ·
  [512 MATCH2 n_dist=1 H=128 identity S1 PASS](../2_Experiments_Registry/run_reports/e25_bridge512_ip_id_match2_nd1_20260915.md) ·
  [1024 MATCH2 n_dist=1 H=128 identity S1 PASS](../2_Experiments_Registry/run_reports/e25_bridge1k_ip_id_match2_nd1_20260915.md) ·
  [1280 MATCH2 n_dist=1 H=128 identity S1 FAIL](../2_Experiments_Registry/run_reports/e25_bridge1k_1280_ip_id_match2_nd1_20260915.md) ·
  [1152 MATCH2 n_dist=1 H=128 identity K1](../2_Experiments_Registry/run_reports/e25_bridge1k_1152_ip_id_match2_nd1_20260915.md) ·
  [256 shuffled chain n_dist=2 glob2 S1 FAIL](../2_Experiments_Registry/run_reports/e25_bridge256_chain_shuf_k13_glob2_20260915.md) ·
  [256 chain_shuffled n_dist=0 glob2 S1 PASS](../2_Experiments_Registry/run_reports/e25_bridge256_chain_shuf0_k13_glob2_20260915.md) ·
  [256 chain n_dist=1 glob2 S1 FAIL](../2_Experiments_Registry/run_reports/e25_bridge256_chain_shuf1_k13_glob2_20260915.md) ·
  [256 chain n_dist=1 glob2 extra hop S1 PASS](../2_Experiments_Registry/run_reports/e25_bridge256_chain_shuf1_k13_glob2_extrahop_20260915.md) ·
  [256 chain n_dist=2 glob2 extra hop S1 PASS](../2_Experiments_Registry/run_reports/e25_bridge256_chain_shuf_k13_glob2_extrahop_20260915.md) ·
  [1280 MATCH2 n_dist=1 extra hop S1 FAIL](../2_Experiments_Registry/run_reports/e25_bridge1k_1280_ip_id_match2_nd1_extrahop_20260915.md) ·
  [1280 MATCH r=8 extra hop S1 FAIL](../2_Experiments_Registry/run_reports/e25_bridge1k_1280_ip_r8_h256_recall_extrahop_20260915.md) ·
  [1536 MATCH identity extra hop S1 FAIL](../2_Experiments_Registry/run_reports/e25_bridge1k_1536_ip_id_h256_recall_extrahop_20260915.md) ·
  [DNA S0 ladder mapped](../2_Experiments_Registry/run_reports/e25_dna_s0_ladder_mapped_20260915.md) ·
  ...
  [1536 MATCH r=1 identity H=256 log](../2_Experiments_Registry/run_reports/e25_bridge1k_1536_ip_id_h256_recall_20260914.md) ·
  [1280 MATCH r=4 H=256 log](../2_Experiments_Registry/run_reports/e25_bridge1k_1280_ip_r4_h256_recall_20260914.md) ·
  [1280 MATCH r=4 rem-on H=256 log](../2_Experiments_Registry/run_reports/e25_bridge1k_1280_ip_r4_rem_h256_recall_20260915.md) ·
  ...
  [288 hops glob2 extra hop](../2_Experiments_Registry/run_reports/e25_bridge288_chain_k13_glob2_extrahop_20260915.md) ·
  [512 MATCH2 n_dist=2 H=128 identity K1](../2_Experiments_Registry/run_reports/e25_bridge512_ip_id_match2_20260915.md) ·
  [512 MATCH2 n_dist=1 H=128 identity S1 PASS](../2_Experiments_Registry/run_reports/e25_bridge512_ip_id_match2_nd1_20260915.md) · [1024 MATCH2 n_dist=1 H=128 identity S1 PASS](../2_Experiments_Registry/run_reports/e25_bridge1k_ip_id_match2_nd1_20260915.md) · [256 chain n_dist=1 glob2 S1 FAIL](../2_Experiments_Registry/run_reports/e25_bridge256_chain_shuf1_k13_glob2_20260915.md) · [256 chain n_dist=2 glob2 extra hop S1 PASS](../2_Experiments_Registry/run_reports/e25_bridge256_chain_shuf_k13_glob2_extrahop_20260915.md) · [1280 MATCH2 n_dist=1 extra hop S1 FAIL](../2_Experiments_Registry/run_reports/e25_bridge1k_1280_ip_id_match2_nd1_extrahop_20260915.md) · [1536 MATCH identity extra hop S1 FAIL](../2_Experiments_Registry/run_reports/e25_bridge1k_1536_ip_id_h256_recall_extrahop_20260915.md) · [DNA S0 ladder mapped](../2_Experiments_Registry/run_reports/e25_dna_s0_ladder_mapped_20260915.md).
...
- **2026-09-15 — E25 DNA S0-capable USER_CORE rungs mapped at stop resolution (no GPU hunt).**
  ...
  dense **S0** (dense ≥ 75%) is mapped. Extra hop is hops-composition only
  (shuffled `n_dist=1/2` PASS; MATCH pooling/identity/MATCH2 length FAIL;
  ordered hops 288 FAIL). Unmapped S0-capable USER_CORE recipes: **none**.
  Later closed as `done_success` (mapped). Next at the time: **STOP: ladder mapped**.
  [report](../2_Experiments_Registry/run_reports/e25_dna_s0_ladder_mapped_20260915.md).
- **2026-09-15 — E25 GPU seq=1536 MATCH (`recall_single`) r=1 identity H=256 log `--message_extra_slot_attends 1` (Odra).**
  Architectural bet at the packed 2-key MATCH identity exclusive-capacity
  wall (H=256 log r=1 identity, glob=1, 64-bit prize, keepswa off, extra
  hops 1). Dense **100% / 63.92 bits** @200 (**S0 PASS**). This-JSON E18
  **live 100% / 63.94 bits** @350. E21 **0 bits @800** (chance every eval;
  **S1 FAIL** vs 0.75× live E18 47.96). Extra hop does not rescue identity
  at 1536. Severed identity was E21 1.50 / E18 63.95. Shuffled n_dist=2
  extra hop 22.60 still mapped. 8k not run.
  Next ONE (do not run): **STOP extra-hop transfer to MATCH identity
  capacity**.
  [report](../2_Experiments_Registry/run_reports/e25_bridge1k_1536_ip_id_h256_recall_extrahop_20260915.md).
- **2026-09-15 — E25 GPU seq=1280 MATCH (`recall_single`) r=8 rem-off H=256 log `--message_extra_slot_attends 1` (Odra).**
  Architectural bet at the packed 2-key MATCH pooling wall (H=256 log
  r=8 frozen mean, glob=1, 64-bit prize, keepswa off, extra hops 1). Dense
  **93.7% / 58.94 bits** @3200 (**S0 PASS**; 87.2% / 55.78 @800). This-JSON
  E18 **live 100% / 63.99 bits** @1200. E21 **0 bits @800** then **0.01
  bits** @3200 (chance every eval; **S1 FAIL** vs 0.75× live E18 47.99).
  Extra hop does not rescue r=8 at 1280. Severed r=8 was E21 0 / E18
  63.95. Shuffled n_dist=2 extra hop 22.60 still mapped. 8k not run.
  Next ONE (do not run): **STOP extra-hop transfer to MATCH pooling**.
  [report](../2_Experiments_Registry/run_reports/e25_bridge1k_1280_ip_r8_h256_recall_extrahop_20260915.md).
- **2026-09-15 — E25 GPU seq=1280 `--recipe recall` MATCH2 n_dist=1 H=128 identity `--message_extra_slot_attends 1` (Odra).**
  Extra-hop transfer at the 2-item MATCH2 length wall (H=128 identity,
  glob=1, 64-bit prize, keepswa off, extra hops 1, `n_items=2`). Dense
  **99.5% / 63.20 bits** @1150 (**S0 PASS**; 75.1% / 36.05 @800). This-JSON
  E18 **0 bits**. E21 **0 bits @800** then **0.01 bits** @1150 (chance
  every eval; **S1 FAIL** vs 0.75× dense 47.40; E18 ≈ 0 so do not pass
  via 0.75×0). Extra hop does not rescue MATCH2 at 1280. Severed 1280
  MATCH2 was E21 0.01 / E18 0. Shuffled n_dist=2 extra hop 22.60 still
  mapped. 8k not run. Next ONE (do not run): **1280 MATCH r=8 rem-off
  H=256 log `--message_extra_slot_attends 1`** (keepswa off, glob=1;
  E18 live 63.95).
  [report](../2_Experiments_Registry/run_reports/e25_bridge1k_1280_ip_id_match2_nd1_extrahop_20260915.md).
- **2026-09-15 — E25 GPU seq=256 `--recipe chain --n_distractors 2` `--key_len 13 --global_layers 2 --message_extra_slot_attends 1` (Odra).**
  Architectural bet at packed shuffled REACHABILITY (H=256 log identity,
  glob=2, 26-bit prize, keepswa off, extra hops 1, n_dist=2 hops=2). Dense
  **93.4% / 22.94 bits** @3200 (**S0 PASS**; 52.3% / 4.68 @800). This-JSON
  E18 **0 bits**. E21 **3.81 bits @800** then **91.5% / 22.60 bits** @3200
  (**S1 PASS** vs 0.75× dense 17.21; E18 ≈ 0 so do not pass via 0.75×0).
  Extra hop rescues packed n_dist=2 without restoring SWA. Severed n_dist=2
  was E21 0 / E18 0. n_dist=1 extra hop 24.08 still mapped. 8k not run.
  Next ONE (do not run): **STOP extra-hop shuffled-distractor extra-steps**
  (do not n_dist=3).
  [report](../2_Experiments_Registry/run_reports/e25_bridge256_chain_shuf_k13_glob2_extrahop_20260915.md).
- **2026-09-15 — E25 GPU seq=256 `--recipe chain --n_distractors 1` `--key_len 13 --global_layers 2 --message_extra_slot_attends 1` (Odra).**
  Architectural bet at the n_dist=1 shuffled exclusive wall (H=256 log
  identity, glob=2, 26-bit prize, keepswa off, extra hops 1). Dense
  **93.8% / 23.92 bits** @3200 (**S0 PASS**; 64.9% / 11.06 @800). This-JSON
  E18 **47.1% / 9.75 bits** @3200. E21 **6.85 bits @800** then **93.6% /
  24.08 bits** @3200 (**S1 PASS** vs 0.75× this-JSON E18 7.31; **PASS** vs
  0.75× dense 17.94; **PASS** vs 0.75× prior live E18 19.08). Extra hop
  composes the extra shuffled edge without restoring SWA. Keepswa 14.77
  S1 FAIL does not transfer. 8k not run. Next ONE (do not run): **256
  `--recipe chain` n_dist=2 `--key_len 13 --global_layers 2
  --message_extra_slot_attends 1`** (keepswa off; do not stack).
  [report](../2_Experiments_Registry/run_reports/e25_bridge256_chain_shuf1_k13_glob2_extrahop_20260915.md).
- **2026-09-15 — E25 GPU seq=256 `--recipe chain --n_distractors 1` `--key_len 13 --global_layers 2 --message_keep_local_swa` (Odra).**
  Architectural bet at the n_dist=1 shuffled exclusive wall (H=256 log
  identity, glob=2, 26-bit prize, keepswa on, extra hops 0). Dense
  **99.2% / 25.56 bits** @3000 (**S0 PASS**; 84.3% / 20.18 @800). E18
  live **80.8% / 20.95 bits** @8000. E21 **1.67 bits @800** then **6.52
  @3000** then **63.8% / 14.77 bits** @8000 (**S1 FAIL** vs 0.75× live
  E18 15.71 by 0.94 bits; **FAIL** vs 0.75× dense 19.17). Keepswa lifts
  vs severed 0/6.28 but does not compose the extra edge. Hops 272
  keepswa S1 PASS 25.55 does not transfer. Wall **(n_dist=0 S1 PASS,
  n_dist=1 S1 FAIL]** even unsevered. 8k ran. Next ONE (do not run):
  **256 `--recipe chain --n_distractors 1` `--key_len 13 --global_layers 2
  --message_extra_slot_attends 1`** (keepswa off; do not stack).
  [report](../2_Experiments_Registry/run_reports/e25_bridge256_chain_shuf1_k13_glob2_keepswa_20260915.md).
- **2026-09-15 — E25 GPU seq=256 `--recipe chain --n_distractors 1` `--key_len 13 --global_layers 2` (Odra).**
  Unmeasured USER_CORE one-extra-edge shuffled REACHABILITY interpolant at
  the ordered-hops glob=2 geometry (H=256 log identity, n_dist=1, 26-bit
  prize). Dense **86.4% / 21.54 bits** @3200 (**S0 PASS**; 60.2% / 10.51
  @800). E18 live **99.0% / 25.44 bits** @2450. E21 **0 bits @800** then
  **46.0% / 6.28 bits** @3200 (**S1 FAIL** vs 0.75× live E18 19.08; **FAIL**
  vs 0.75× dense 16.16). Same geometry n_dist=0 was E21 16.60 S1 PASS; n_dist=2
  was E21 0 / E18 0. One extra shuffled hop-edge kills exclusive composition
  at the 800 floor. Shuffled distractor wall **(n_dist=0 S1 PASS, n_dist=1
  S1 FAIL]**. 8k not run. Next ONE (do not run): **STOP shuffled-distractor
  extra-steps at this geometry**.
  [report](../2_Experiments_Registry/run_reports/e25_bridge256_chain_shuf1_k13_glob2_20260915.md).
- **2026-09-15 — E25 GPU seq=256 `--recipe chain_shuffled` n_dist=0 `--key_len 13 --global_layers 2` (Odra).**
  Unmeasured USER_CORE two-edge shuffled REACHABILITY at the ordered-hops
  glob=2 geometry (H=256 log identity, n_dist=0, 26-bit prize). Dense
  **99.3% / 25.66 bits** @700 (**S0 PASS**; 73.7% / 12.61 @600). E18
  live **71.5% / 16.37 bits** @800. E21 **71.9% / 16.60 bits** @800
  (**S1 PASS** vs 0.75× live E18 12.28; **FAIL** vs 0.75× dense 19.24).
  Same geometry n_dist=2 was E21 0 / E18 0. Extra shuffled distractor
  edges are the wall, not two-edge shuffle. Shuffled distractor wall
  **(n_dist=0 S1 PASS, n_dist=2 S1 FAIL]**. 8k not run. Next ONE (do not
  run): **256 `--recipe chain --n_distractors 1` same geometry**.
  [report](../2_Experiments_Registry/run_reports/e25_bridge256_chain_shuf0_k13_glob2_20260915.md).
- **2026-09-15 — E25 GPU seq=256 `--recipe chain` shuffled REACHABILITY `--key_len 13 --global_layers 2` (Odra).**
  Unmeasured USER_CORE recipe at the ordered-hops glob=2 geometry (H=256
  log identity, n_dist=2, 26-bit prize). Dense **93.1% / 22.89 bits**
  @3200 (**S0 PASS**; 73.4% / 13.18 @800). E18 **0 bits**. E21 **0 bits**
  chance @800 and @3200 (**S1 FAIL** vs 0.75× dense 17.17; do not pass
  via 0.75×0). Same geometry ordered hops was E21 **25.85 S1 PASS**.
  Shuffle is the wall for both global-read arms. 8k not run. Next ONE
  (do not run): **256 `--recipe chain_shuffled` n_dist=0 same geometry**.
  [report](../2_Experiments_Registry/run_reports/e25_bridge256_chain_shuf_k13_glob2_20260915.md).
- **2026-09-15 — E25 GPU seq=1152 `--recipe recall` MATCH2 n_dist=1 H=128 identity (Odra).**
  Length pin between 1024 2-item MATCH2 S1 PASS and 1280 S1 FAIL. Packed
  2-item MATCH2 (`--n_distractors 1`, `n_items=2`, packed 32 / 64-bit
  prize) at the 1024/1280 H=128 identity compressor. Dense **24.1% /
  0.00 bits** @3200 (**K1**; 24.9% @800; chance every eval; 0.595M).
  e18/e21 skipped. 8k not run (dense already `k1_mult=4`). Do not 16k. Do
  not relabel 1024 MATCH2 61.81 or 1280 MATCH2 0.01 as this score.
  Item-count wall stays **(2-item S1 PASS, 3-item dense K1]**. 2-item S1
  length among S0-calibrated lengths stays **(1024 S1 PASS, 1280 FAIL]**.
  1152 is a dense K1 hole, not an S1 interior. Next ONE (do not run):
  **STOP MATCH2 2-item length extra-steps**.
  [report](../2_Experiments_Registry/run_reports/e25_bridge1k_1152_ip_id_match2_nd1_20260915.md).
- **2026-09-15 — E25 GPU seq=1280 `--recipe recall` MATCH2 n_dist=1 H=128 identity (Odra).**
  Length grow after 1024 2-item MATCH2 S1 PASS. Packed 2-item MATCH2
  (`--n_distractors 1`, `n_items=2`, packed 32 / 64-bit prize) at the
  1024-passing H=128 identity compressor. Dense **98.9% / 62.94 bits**
  @3200 (**S0 PASS**; 78.9% @800; 0.595M). E18 **0 bits** @3200 (chance
  every eval). E21 **25.0% / 0 @800** and **26.1% / 0.01 bits** @3200
  (**S1 FAIL** vs 0.75× dense 47.21; do not pass via 0.75×0; chance every
  eval; flow 0.000). K2 PASS (`e18_local` 0). 8k not run (chance floor). Do
  not 16k. Do not relabel 1024 MATCH2 61.81 or 2-key MATCH identity at 1280
  (H=256 log 63.94) as this score. Item-count wall stays **(2-item S1
  PASS, 3-item dense K1]**. 2-item length wall **(1024 S1 PASS, 1280
  FAIL]**. Next ONE (do not run): **1152 MATCH2 `--n_distractors 1` H=128
  identity**.
  [report](../2_Experiments_Registry/run_reports/e25_bridge1k_1280_ip_id_match2_nd1_20260915.md).
- **2026-09-15 — E25 GPU seq=1024 `--recipe recall` MATCH2 n_dist=1 H=128 identity (Odra).**
  Length grow after 512 2-item MATCH2 S1 PASS. Packed 2-item MATCH2
  (`--n_distractors 1`, `n_items=2`, packed 32 / 64-bit prize) at the
  512-passing H=128 identity compressor. Dense **93.5% / 58.81 bits**
  @3200 (**S0 PASS**; 35.0% @800; 0.595M). E18 **0 bits** @3200 (chance
  every eval). E21 **58.8% / 24.86 @800** then **97.8% / 61.81 bits**
  @3200 (**S1 PASS** vs 0.75× dense 44.11; do not pass via 0.75×0; beats
  dense 58.81; flow 0.966). K2 PASS (`e18_local` 0). 8k not run. Do not
  16k. Do not relabel 512 MATCH2 20.78 as this score. Item-count wall
  stays **(2-item S1 PASS, 3-item dense K1]**. Next ONE (do not run):
  **1280 MATCH2 `--n_distractors 1` H=128 identity**.
  [report](../2_Experiments_Registry/run_reports/e25_bridge1k_ip_id_match2_nd1_20260915.md).
- **2026-09-15 — E25 GPU seq=512 `--recipe recall` MATCH2 n_dist=1 H=128 identity (Odra).**
  Calibrated shrink after 3-item MATCH2 dense K1. Packed 2-item MATCH2
  (`--n_distractors 1`, `n_items=2`, packed 24 / 48-bit prize) at the 512
  `recall_single` identity geometry. Dense **99.3% / 47.03 bits** @1650
  (**S0 PASS**; 66.5% @800; 0.595M). E18 live **68.3% / 26.66 bits** @1650
  (plateau 66–68%). E21 **35.2% @800** then **55.9% / 20.78 bits** @1650
  (**S1 PASS** vs 0.75× live E18 19.99; **FAIL** vs 0.75× dense 35.27; flow
  0.433). K2 PASS (`e18_local` 0.02). 8k not run. Do not 16k. Do not relabel
  `recall_single` 43.08 as MATCH2. Item-count wall **(2-item S1 PASS, 3-item
  dense K1]**. Next ONE (do not run): **1024 MATCH2 `--n_distractors 1`
  H=128 identity**.
  [report](../2_Experiments_Registry/run_reports/e25_bridge512_ip_id_match2_nd1_20260915.md).
- **2026-09-15 — E25 GPU seq=512 `--recipe recall` MATCH2 n_dist=2 H=128 identity (Odra).**
  Unmeasured original DNA MATCH2 (`n_distractors=2`, packed 24 / 48-bit
  prize) at the 512 `recall_single` identity geometry. Dense **55.8% /
  18.44 bits** @3200 (**K1**; best 55.9% @2450; 51.8% @800; 0.595M).
  e18 / e21 / e18_local skipped. 8k not run. Do not 16k. Same H=128
  identity as 512 `recall_single` S1 PASS **43.08**. Three-item MATCH2 is
  live for dense (18 of 48 bits) and not S0. Do not relabel
  `recall_single` as MATCH2. Next ONE (do not run): **512 MATCH2
  `--n_distractors 1` H=128 identity**.
  [report](../2_Experiments_Registry/run_reports/e25_bridge512_ip_id_match2_20260915.md).
- **2026-09-15 — E25 GPU seq=288 chain_ordered --key_len 13 `--global_layers 2 --message_extra_slot_attends 1` (Odra, H=256 log).**
  Same 272 glob2 extra-hop S1 PASS compressor plus `--message_extra_slot_attends 1`
  (`--scale bridge --seq_len 288`; window 16 < gap 64; keep_local_swa
  **off**). Dense **99.5% / 25.77 bits** @1850 (**S0 PASS**; crossed 75%
  at 1550; early-stop; 2.802M). E18 **26.8% / 0 bits** @1850 (~0). E21
  **26.8% / 0 bits** @800 and **23.8% / 0 bits** @1850 (**S1 FAIL** vs
  0.75× dense 19.32; do not pass via 0.75×0; chance every eval). K2 PASS
  (`e18_local` 0; no raw-prefix leak). 8k not run. Do not 16k. Same recipe
  without extra hops was E21 **0 bits** at 288. Extra exclusive hop
  substitutes for local SWA at 272 and does not at 288. Extra-hop hops
  wall **(272 S1 PASS, 288 FAIL]**. Default `--message_extra_slot_attends`
  stays **0**. Default `--message_keep_local_swa` stays **false**. Next
  ONE (do not run): **STOP extra-hop hops length extra-steps at this
  16-token step** (not 320 here). `--hops 1` is illegal.
  [report](../2_Experiments_Registry/run_reports/e25_bridge288_chain_k13_glob2_extrahop_20260915.md).
- **2026-09-15 — E25 GPU seq=272 chain_ordered --key_len 13 `--global_layers 2 --message_extra_slot_attends 1` (Odra, H=256 log).**
  Same 272 glob2 S1 FAIL compressor plus `--message_extra_slot_attends 1`
  (`--scale bridge --seq_len 272`; window 16 < gap 64; keep_local_swa
  **off**). Dense **80.5% / 15.84 bits** @3200 (**S0 PASS**; crossed 75%
  at 2850; 2.802M). E18 live **10.17 bits** @3200 then **99.0% / 25.49
  bits** @2550. E21 **28.0% / 0 bits** @800 then **39.9% / 8.49 bits**
  @3200 (climbing short of 0.75× dense 11.88) then extra-step **99.0% /
  25.48 bits** @5450 (**S1 PASS** vs 0.75× live E18 19.12 and vs 0.75×
  dense 11.88). K2 PASS (`e18_local` 0; no raw-prefix leak). 8k ran. Do
  not 16k. Same recipe without extra hops was E21 **0.02 bits @8k**.
  Extra exclusive hop substitutes for local SWA at 272 (keepswa 272 was
  **25.55**). SELECT 1024 extra hop stays 0 bits. Default
  `--message_extra_slot_attends` stays **0**. Default
  `--message_keep_local_swa` stays **false**. Next ONE (do not run):
  parent may later map hops length with extra hop (not keepswa; not 320).
  `--hops 1` is illegal.
  [report](../2_Experiments_Registry/run_reports/e25_bridge272_chain_k13_glob2_extrahop_20260915.md).
- **2026-09-15 — E25 GPU seq=696 select_1decoy r=1 identity `--message_keep_local_swa` (Odra, H=256 log).**
  Same 696 identity SELECT cliff (`--scale bridge_1k --seq_len 696`; window
  16 < gap 64) plus `--message_keep_local_swa`. Dense **100% / 63.92 bits**
  @200 (**S0 PASS**). E18 live **100% / 63.91 bits** @350. E21 **25.0% /
  0.01 bits** @800 (**S1 FAIL** vs 0.75× live E18 47.93 and vs 0.75× dense
  47.94; chance every eval). K2 PASS (`e18_local` 0; no raw-prefix leak).
  8k not run. Do not 16k. Same recipe without the flag was E21 **0 bits**.
  Hops 272 keep_local_swa S1 PASS does not transfer. SELECT cliff is
  exclusive type-then-value, not hops-class SWA sever. Wall **(692 PASS,
  696 FAIL]** stands even unsevered. Default `--message_keep_local_swa`
  stays **false**. Next: **STOP SELECT keepswa stacks** (not 694 without
  the flag). Do not pack_stride / spread / window 32.
  [report](../2_Experiments_Registry/run_reports/e25_bridge1k_696_ip_id_h256_keepswa_select_20260915.md).
- **2026-09-15 — E25 GPU seq=288 chain_ordered --key_len 13 `--global_layers 2 --message_keep_local_swa` (Odra, H=256 log).**
  Same 272 glob2 keep_local_swa S1 PASS compressor at `--scale bridge
  --seq_len 288` (window 16 < gap 64). Dense **47.0% / 8.80 bits** @3200
  (**S0 FAIL / K1**; best 50.7% @3000; 2.802M; never crossed 75%). e18 /
  e21 / e18_local skipped. Hunt exit 2. 8k not run. Do not 16k. The flag
  is E21-only; prior 288 without it was dense **93.1% / 22.20 bits** (same
  seed 0, no code diff). Keep-SWA hops wall **(272 S1 PASS, 288 K1]**.
  Live keep-SWA S1 remains 272 **25.55 bits**. Default
  `--message_keep_local_swa` stays **false**. Next: **STOP keep-SWA hops
  length extra-steps at this 16-token step** (not 320 here). `--hops 1`
  is illegal.
  [report](../2_Experiments_Registry/run_reports/e25_bridge288_chain_k13_glob2_keepswa_20260915.md).
- **2026-09-15 — E25 GPU seq=272 chain_ordered --key_len 13 `--global_layers 2 --message_keep_local_swa` (Odra, H=256 log).**
  ...
  **27.6% / 0 bits** @800 then **38.3% / 3.72 bits** @3200 (climbing short of
  ...
  `--message_keep_local_swa` stays **false**. Keep-SWA length map at 288 ran
  as this-JSON K1 (dense 47.0%; E21 not scored). `--hops 1` is illegal.
...
- **2026-09-15 — E25 GPU seq=1280 recall_single r=4 remainder-on H=256 SSMax log (Odra).**
  ...
  `--hidden 256 --global_logit_scale log`, glob_layers 1, batch 32. Same
  compressor as r=4 rem-off FAIL plus leftover pooling (leftover **2**,
  QUERY 1242). Dense **99.7% / 62.39 bits** @1550 (**S0 PASS**). E18
  **75.7% / 39.90 bits** @1550 (live) and **63.96 bits** @400 (live). E21
  **39.0% / ~6.80 bits** @800 (climbing short of S1) then **72.0% /
  45.31 bits** @1550, then **22.8% / 0 bits** @8000 (**S1 FAIL** vs 0.75×
  live E18 47.97 and vs 0.75× dense 46.79; 1550 climb did not replicate).
  K2 **PASS**. Leftover rescue that worked at 512 MATCH r=10 does not
  hold at 1280 r=4. Pooling-ratio wall stays **(r=1 PASS, r=4 FAIL]**.
  8k ran. Do not 16k. Next: STOP remainder stacks at 1280 r=4. Do not r=8
  rem-on. Do not r=2/r=6. Do not MATCH 1408. Default remainder stays off.
  [report](../2_Experiments_Registry/run_reports/e25_bridge1k_1280_ip_r4_rem_h256_recall_20260915.md).
- **2026-09-14 — E25 GPU seq=1280 recall_single r=4 frozen mean H=256 SSMax log (Odra).**
  `--scale bridge_1k --seq_len 1280` packed MATCH, inplace frozen 4-token
  mean (`--message_ratio 4 --message_identity_slots`), remainder **off**,
  `--hidden 256 --global_logit_scale log`, glob_layers 1, batch 32. Same
  length as r=1 identity PASS / r=8 exclusive FAIL (pooling-ratio map, not
  a length extra-step). Dense **100% / 63.98 bits** @250 (**S0 PASS**).
  E18 **100% / 63.98 bits** @350 (live) and **63.05 bits** @6200 (live).
  E21 **47.4% / 24.91 bits** @800 (climbing, S1 FAIL vs 0.75× live E18
  47.98) then **22.8% / 0 bits** @8000 (**S1 FAIL** vs 0.75× live E18
  47.29 and vs 0.75× dense 47.98; 800 climb did not replicate). K2 **PASS**.
  Pooling-ratio wall at 1280 **(r=1 PASS, r=4 FAIL]**. 8k ran. Do not 16k.
  Remainder-on leftover rescue ran (S1 FAIL 0 @8k). Do not MATCH 1408.
  [report](../2_Experiments_Registry/run_reports/e25_bridge1k_1280_ip_r4_h256_recall_20260914.md).
- **2026-09-14 — E25 GPU seq=1536 recall_single r=1 identity H=256 SSMax log (Odra).**
  `--scale bridge_1k --seq_len 1536` packed MATCH, inplace hard identity r=1,
  remainder **off**, `--hidden 256 --global_logit_scale log`, glob_layers 1,
  batch 32. Same compressor as 1280 identity PASS. Dense **100% / 63.95
  bits** @200 (**S0 PASS**). E18 **100% / 63.95 bits** @400 (live, not
  ~0). E21 **29.2% / 1.50 bits** @800 (chance through 750, last-eval wiggle
  flow 0.023; **S1 FAIL** vs 0.75× live E18 47.96 and vs 0.75× dense
  47.96). K2 **PASS**. Identity MATCH wall **(1280 PASS, 1536 FAIL]**.
  8k not run. Next: STOP identity MATCH extra-steps (do not 1408). Do not
  2048. Do not stack `keep_local_swa` / extra hops / glob=2 / anchors.
  [report](../2_Experiments_Registry/run_reports/e25_bridge1k_1536_ip_id_h256_recall_20260914.md).
- **2026-09-14 — E25 GPU seq=1280 recall_single r=1 identity H=256 SSMax log (Odra).**
  `--scale bridge_1k --seq_len 1280` packed MATCH, inplace hard identity r=1,
  remainder **off**, `--hidden 256 --global_logit_scale log`, glob_layers 1,
  batch 32. Same length as the r=8 FAIL (architecture change, not a length
  extra-step). Dense **100% / 63.97 bits** @250 (**S0 PASS**). E18 **100% /
  63.95 bits** @400 (live, not ~0). E21 **100% / 63.94 bits** @800 (chance
  through 600, click 47.9% @650, 73.5% @750; **S1 PASS** vs 0.75× live E18
  47.96 and vs 0.75× dense 47.97). K2 **PASS**. r=8 at 1280 was **0 bits**.
  Exclusive identity binds a key at 1280; the 1280 wall is r=8 pooling, not
  identity capacity. 8k not run. Next: parent may later map identity MATCH
  length (not 1152 r=8). Do not stack `keep_local_swa` / extra hops / glob=2 /
  anchors.
  [report](../2_Experiments_Registry/run_reports/e25_bridge1k_1280_ip_id_h256_recall_20260914.md).
- **2026-09-14 — E25 GPU seq=1280 recall_single r=8 rem-off H=256 SSMax log (Odra).**
  `--scale bridge_1k --seq_len 1280` packed MATCH, inplace identity mean r=8,
  remainder **off**, `--hidden 256 --global_logit_scale log`, glob_layers 1,
  batch 32. Dense **99.9% / 63.85 bits** @550 (**S0 PASS**). E18 **100% /
  63.95 bits** @400 (live, not ~0). E21 **22.8% / 0 bits** @800 (chance
  every eval; **S1 FAIL** vs 0.75× live E18 47.96 and vs 0.75× dense
  47.89). K2 **PASS**. Exclusive MATCH that passed at 1024 is chance at
  1280 with leftover residue 2. Exclusive wall **(1024 PASS, 1280
  FAIL]**. 8k not run. Next: STOP MATCH length extra-steps (do not
  1152/1408); parent decides architecture.
  [report](../2_Experiments_Registry/run_reports/e25_bridge1k_1280_ip_r8_h256_recall_20260914.md).
- **2026-09-14 — E25 GPU seq=1536 recall_single r=8 rem-off H=256 SSMax log (Odra).**
  ...
  1536 with leftover residue 2. Exclusive wall was **(1024 PASS, 1536
  FAIL]**. 8k not run. Next: seq=1280 tighten (ran).
...
- **2026-09-14 — E25 GPU seq=264 chain_ordered --key_len 13 `--global_layers 2` (Odra, H=256 log).**
  ...
  (**S0 PASS**; crossed 75% at 2900; 2.802M). E18 **0.01 bits** @3200 (~0)
  then live **48.0% / 9.87 bits** @8000. E21 **25.1% / 0 bits** @800 then
  **49.3% / 11.00 bits** @3200 (climbing short of 0.75× dense 13.24) then
  extra-step **99.0% / 25.61 bits** @4050 (**S1 PASS** vs 0.75× live E18
  7.40 and vs 0.75× dense 13.24). K2 PASS. 8k ran. Do not 16k. E21 wall
  **(264 S1 PASS, 272 FAIL]**. Next: seq=268 `--key_len 13` `--global_layers
  2` (do not run it). `--hops 1` is illegal.
  [report](../2_Experiments_Registry/run_reports/e25_bridge264_chain_k13_glob2_20260914.md).
