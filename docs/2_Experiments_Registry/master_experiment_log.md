...
| E24 | E18 capability limits on a BAPO DNA ladder vs dense decoder-only and encoder-decoder | **ahead** — tiny + 512/1024/2k/4k INDEX measured (S1 pass @512 and @1024 with SSMax/H=512; S1 fail @2048 and @4k; 4k S0 closed; 16k open) | [E24](../experiments_specs/ahead/E24_e18_bapo_capability_ladder.md) · [tiny](run_reports/e24_tiny_bapo_ladder_20260913.md) · [bridge](run_reports/e24_bridge512_bapo_ladder_20260913.md) · [medium 4k](run_reports/e24_medium_4k_bapo_ladder_20260913.md) |
...
| 2026-09-13 | E24 | `bapo_bridge512` | GPU right-align INDEX · Polonez/Odra · <3M | seq=512 copy E18 **100% / 64 bits**; seq=1024 copy dense 99.9% E18 **0 bits**; 512 recall E18 **0 bits** @2500 vs dense 32 | MIXED — S1 dies between 512 and 1024 at H=256 none; S2 is query-key not position. 4k S0 was open. | [spec](../experiments_specs/ahead/E24_e18_bapo_capability_ladder.md) · [report](run_reports/e24_bridge512_bapo_ladder_20260913.md) |
| 2026-09-13 | E24 | `e18_1k_ssmax` + `e18_1k_h512` | seq=1024 right-align · Polonez | SSMax log: E18 **100% / 64 bits** @1400; H=512: E18 **100% / 64 bits** @2100; e18_local chance | 1024 S1 fail was dilution at 2.7M, not a hard one-read limit. | [spec](../experiments_specs/ahead/E24_e18_bapo_capability_ladder.md) · [report](run_reports/e24_medium_4k_bapo_ladder_20260913.md) |
| 2026-09-13 | E24 | `b2k_h512_warm` + `b2k_ssmax` | seq=2048 H=512 10.8M · Odra | dense **100% / 64 bits**; E18 **0 bits** @6000 with and without SSMax log | S1 fail at 2048. SSMax does not unstick 2k. | [spec](../experiments_specs/ahead/E24_e18_bapo_capability_ladder.md) · [report](run_reports/e24_medium_4k_bapo_ladder_20260913.md) |
| 2026-09-13 | E24 | `right4k_warm` + `right4k_warm_s1` | seq=4096 16M warm right-align · Polonez | dense **99.3% / 63.1 bits** @350 (seed 0) and **99.5%** (seed 1); E18 **0 bits** @8000 | 4k INDEX S0 closed; E18 S1 fail on the exact recipe. 4k recall K1. | [spec](../experiments_specs/ahead/E24_e18_bapo_capability_ladder.md) · [report](run_reports/e24_medium_4k_bapo_ladder_20260913.md) |
| 2026-09-13 | E24 | `bapo_glyph_tiny_s0` + E18 | Glyph tiny CPU · H=128 0.59M | `copy_span` E18 **99.3% / 95 bits**; `fact_markov_single` E18 **99.1% / 47 bits**; reverse/every_k/filter_mod K1 | Glyph S1 pass; Glyph keyed-fact is not the DNA S2 wall. | [spec](../experiments_specs/ahead/E24_e18_bapo_capability_ladder.md) · [report](run_reports/e24_medium_4k_bapo_ladder_20260913.md) |
...
| 2026-09-13 | E24 bridge 512/1024 probe | right-align DNA, Polonez/Odra, no checkpoint | 512 copy E18 flow **0.999** vs 0.992 · 1024 copy E18 **0** vs 0.994 at H=256 none · 512 recall E18 **0** vs 0.992 | 1024 none is dilution; see medium report for SSMax/H=512 | [spec](../experiments_specs/ahead/E24_e18_bapo_capability_ladder.md) · [report](run_reports/e24_bridge512_bapo_ladder_20260913.md) |
| 2026-09-13 | E24 4k INDEX + Glyph | right-align 4k 16M + Glyph tiny CPU | 4k copy dense flow **0.986** vs E18 **0** · 2k copy E18 **0** vs 0.999 · Glyph copy_span E18 flow **0.986** · Glyph fact E18 **0.987** | 4k S0 pass, E18 fail; Glyph S1/S2-on-fact pass | [spec](../experiments_specs/ahead/E24_e18_bapo_capability_ladder.md) · [report](run_reports/e24_medium_4k_bapo_ladder_20260913.md) |
...
- [E24 medium 4k INDEX + Glyph tiny S0 — E18 vs dense (Sep 13)](run_reports/e24_medium_4k_bapo_ladder_20260913.md)
