...
|| 2026-03-04 | `prefix_diff_H512L6C128D2_*` | H512 **L6** C128 D2 (prefix→suffix diffusion) | Minipile (1x) | Polonez (4x 3090) | **20** | None (clean baseline), ELBO=True, t_min=0.3 | *pending* | *pending* | *pending* | -- | *pending* | `arch/prefix-diffusion-20260304` | **TODO 13a — RUNNING.** SODA-style: encoder sees clean prefix (30-50%), decoder generates suffix via masked diffusion. Hypothesis: prefix generation forces semantic concepts because decoder generates DIFFERENT content than encoder saw. Decision gate: STS-B > 0.50, rank > 30/128. |
