...
> **Focus note (2026-08-17) — E18 addressable concept RAM (draft + plan); E17c 300M mixed, no 1B.**
...
> the same carry pressure. No launch until go-ahead.
> [E18](../experiments_specs/ahead/E18_addressable_concept_ram.md) ·
> [plan](../experiments_specs/ahead/E18_addressable_concept_ram_plan.md) ·
...
| E18 | Addressable concept RAM (sparse location write/read) | draft + plan (awaiting go-ahead) | [E18](../experiments_specs/ahead/E18_addressable_concept_ram.md) · [plan](../experiments_specs/ahead/E18_addressable_concept_ram_plan.md) |
