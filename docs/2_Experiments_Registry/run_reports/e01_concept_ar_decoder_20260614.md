...
**Related TODO:** E01 in `docs/experiments_specs/done_failed/E01_concept_ar_decoder.md`
...
*Related: `master_experiment_log.md`, `docs/experiments_specs/done_failed/E01_concept_ar_decoder.md`, `agenda.md`*
