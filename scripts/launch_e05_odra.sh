...
# batch 8, epochs 0.5, after attempt 2 diverged at step 40k under LR 1e-4 / clip 1.0.
# Batch 8 is the known-stable size at seq 2048 (batch 10 OOM'd at step 21k after
# 6h on a high-long-suffix batch; batch 12 OOM'd in <10 min).
...
export GRADIENT_ACCUMULATION_STEPS="${GRADIENT_ACCUMULATION_STEPS:-3}"   # effective 8*3*3=72
