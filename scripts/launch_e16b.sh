...
# Keep 4K tokenized corpora out of the immutable 2K Gemma cache tree by default.
# An explicit caller override still wins (needed for isolated verification and mirrors E17b).
