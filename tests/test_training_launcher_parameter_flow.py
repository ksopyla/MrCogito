...
def test_e17d_wrapper_pins_attn_residual_and_no_carry_protocol(tmp_path):
    data_root = tmp_path / "gemma_4k"
    data_root.mkdir()
    manifest = data_root / "e16b_long_4k_v1_gemma_manifest.json"
    manifest.write_text("{}", encoding="utf-8")
