"""Logistics domain adapter (v1 stub)."""
...
class LogisticsAdapter:
    ...
    def generate(self, *, seed: int, split: str, distractor_ratio: float = 0.35) -> EventGraph:
        raise NotImplementedError(
            "logistics adapter is v1 — implement after detective/se_debug MVP"
        )

    def solve(self, graph: EventGraph, query: Query) -> str:
        raise NotImplementedError("logistics adapter is v1")


register_adapter(LogisticsAdapter())
